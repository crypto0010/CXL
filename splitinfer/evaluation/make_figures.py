...
def fig_crossover():
    ...
    for p in pts: ax.annotate(p["link"], (p["bytes_per_s"], ax.get_ylim()[0] * 1.3), fontsize=5, rotation=90, ha="center", va="bottom", color="#555")
...
def fig_e2():
    ...
    ax.set_yscale("log"); ax.set_xticks(list(x)); ax.set_xticklabels(names, fontsize=6)
